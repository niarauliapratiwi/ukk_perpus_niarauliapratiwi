    ...
    <div class="login_wrapper">
        ...
        <section class="login_content">
            ...
            <form method="POST" action="index.php">
                <h2 style="color:black;">Login Perpustakaan Digital</h2>
            ...
            <div class="row d-flex justify-content-between">
                ...
                <button class="btn btn-primary rounded col-md-6" type="submit" name="login">Login</button>
            </div>
            ...
            <div class="separator">
                ...
                <a href="index.php#signup" class="to_register"> Registrasi Akun </a>
                </p>
        ...
        <section class="login_content">
            <form method="POST" action="index.php">
            <h2 style="color:black;">Registrasi Akun</h2>
            <div>
            ...
            <input type="text" name="level" class="form-control mb-3" value="Peminjam" readonly>
            <div>
