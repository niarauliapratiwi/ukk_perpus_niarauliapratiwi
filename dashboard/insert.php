            ...
            <form class="form-label-left input_mask" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-md-9 col-sm-9  offset-md-3">
                        <a class="btn btn-pink text-light" href="?page=buku">Cancel</a>
                        <button class="btn btn-pink2 text-light" type="reset">Reset</button>
                        <button type="submit" class="btn btn-pink1 text-light" name="submit">Submit</button>
                    </div>
                </div>
